...
import chromeStorageSyncStore from '../../shared/util/chromeStorageSyncStore';
...
class ApplicationStoreManager {
	...
	async reconstruct(): Promise<ApplicationStoreManager> {
		try {
	...
	updateStore(obj: Record<string, any>) {
